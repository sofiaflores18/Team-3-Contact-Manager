...
### login.php
Script that handles sign up and login authentication.

### contacts.php
Script that handles CRUD operations (Create, read, update, delete). Should be able to get contacts, add, edit, delete, etc.